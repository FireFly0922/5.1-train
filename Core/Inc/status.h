...
typedef enum {
    ...
    ROUTE_STAGE_WAIT_ROUTE,
    ROUTE_STAGE_LINE_FOLLOW,
    ROUTE_STAGE_CROSS_DETECTED,
    ROUTE_STAGE_TURN_LEFT,
    ROUTE_STAGE_TURN_RIGHT,
    ROUTE_STAGE_STRAIGHT_THROUGH,
    ROUTE_STAGE_REACQUIRE_LINE,
    ROUTE_STAGE_DONE,
    ROUTE_STAGE_INVALID,
} RouteStage_t;
